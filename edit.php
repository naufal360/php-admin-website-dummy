                ...
                <div class="col-md-12 my-3">
                    <form class="row g-3" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama" value="<?= $mhs['nama'] ?>" autocomplete="off">
                        </div>
                        <div class="col-md-4">
                            <label for="npm" class="form-label">NPM</label>
                            <input type="text" class="form-control" id="npm" name="npm" maxlength="8" value="<?= $mhs['npm'] ?>" autocomplete="off">
                        </div>
                        <div class="col-md-8">
                            <label for="semester" class="form-label">Semester</label>
                            <select id="semester" class="form-select" name="semester">
                                <option><?= $mhs['semester'] ?></option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                                <option>4</option>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="telepon" name="telepon" maxlength="14" value="<?= $mhs['telepon'] ?>" autocomplete="off">
                        </div>
                        <div class="col-md-12">
                            <label for="gambar" class="form-label">Profile Picture</label><br>
                            <img src="img/<?= $mhs['gambar']; ?>" style="width: 150px;" class="my-2">
